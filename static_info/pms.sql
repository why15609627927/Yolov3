...
INSERT INTO `userinfo` VALUES ('200001', '韩世磊', '123456', '3', '信息技术部', '80.68', '13759680673', '610528199702131813','1245160877@qq.com', '西安', '男');

DROP TABLE IF EXISTS `examform`;
CREATE TABLE `examform` (
  `userId` varchar(10) NOT NULL,
  `examproject1` varchar(255) NOT NULL,
  `examproject2` varchar(255) NOT NULL,
  `examproject3` varchar(255) NOT NULL,
  `examindex1` varchar(255) NOT NULL,
  `examindex2` varchar(255) NOT NULL,
  `examindex3` varchar(255) NOT NULL,
  `examindex4` varchar(255) NOT NULL,
  `examindex5` varchar(255) NOT NULL,
  `examindex6` varchar(255) NOT NULL,
  `examratio1` varchar(64) NOT NULL,
  `examratio2` varchar(64) NOT NULL,
  `examratio3` varchar(64) NOT NULL,
  `examratio4` varchar(64) NOT NULL,
  `examratio5` varchar(64) NOT NULL,
  `examratio6` varchar(64) NOT NULL,
  `examsmallgoal1` varchar(255) NOT NULL,
  `examsmallgoal2` varchar(255) NOT NULL,
  `examgoal1` varchar(1024) NOT NULL,
  `examgoal2` varchar(1024) NOT NULL,
  `examgoal3` varchar(1024) NOT NULL,
  `examgoal4` varchar(1024) NOT NULL,
  `examgoal5` varchar(1024) NOT NULL,
  `examgoal6` varchar(1024) NOT NULL,
  `examgoal7` varchar(1024) NOT NULL,
  `examgoal8` varchar(1024) NOT NULL,
  `examgoal9` varchar(1024) NOT NULL,
  `examgoal10` varchar(1024) NOT NULL,
  `examgoal11` varchar(1024) NOT NULL,
  `examgoal12` varchar(1024) NOT NULL,
  `examgoal13` varchar(1024) NOT NULL,
  PRIMARY KEY (`userId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;


DROP TABLE IF EXISTS `examsetting`;
CREATE TABLE `examsetting` (
...
DROP TABLE IF EXISTS `selfevalinfo`;
CREATE TABLE `selfevalinfo` (
     `userId` varchar(10) NOT NULL,
     `examname` varchar(255) NOT NULL,
     `selfeval1` varchar(1024) DEFAULT NULL,
     `selfeval2` varchar(1024) DEFAULT NULL,
     `selfeval3` varchar(1024) DEFAULT NULL,
     `selfeval4` varchar(1024) DEFAULT NULL,
     `selfeval5` varchar(1024) DEFAULT NULL,
     `selfevaldate` date NOT NULL,
     `state` int(1) NOT NULL,
    PRIMARY KEY (`userId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

DROP TABLE IF EXISTS `directevalinfo`;
CREATE TABLE `directevalinfo` (
     `userId` varchar(10) NOT NULL,
     `examname` varchar(255) NOT NULL,
     `directeval1` varchar(1024) DEFAULT NULL,
     `directeval1goal` int(3) DEFAULT NULL,
     `directeval2` varchar(1024) DEFAULT NULL,
     `directeval2goal` int(3) DEFAULT NULL,
     `directeval3` varchar(1024) DEFAULT NULL,
     `directeval3goal` int(3) DEFAULT NULL,
     `directeval4` varchar(1024) DEFAULT NULL,
     `directeval4goal` int(3) DEFAULT NULL,
     `directeval5` varchar(1024) DEFAULT NULL,
     `directeval5goal` int(3) DEFAULT NULL,
     `directscore` double(3,2) DEFAULT NULL,
     `directevaldate` date NOT NULL,
     `state` int(1) NOT NULL,
    PRIMARY KEY (`userId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

DROP TABLE IF EXISTS `crossevalinfo`;
CREATE TABLE `crossevalinfo` (
   `userId` varchar(10) NOT NULL,
   `examname` varchar(255) NOT NULL,
   `crosseval1` varchar(1024) DEFAULT NULL,
   `crosseval1goal` int(3) DEFAULT NULL,
   `crosseval2` varchar(1024) DEFAULT NULL,
   `crosseval2goal` int(3) DEFAULT NULL,
   `crosseval3` varchar(1024) DEFAULT NULL,
   `crosseval3goal` int(3) DEFAULT NULL,
   `crosseval4` varchar(1024) DEFAULT NULL,
   `crosseval4goal` int(3) DEFAULT NULL,
   `crosseval5` varchar(1024) DEFAULT NULL,
   `crosseval5goal` int(3) DEFAULT NULL,
   `crossscore` double(3,2) DEFAULT NULL,
   `crossevaldate` date NOT NULL,
   `state` int(1) NOT NULL,
   PRIMARY KEY (`userId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;


DROP TABLE IF EXISTS `deductpointinfo`;
CREATE TABLE `deductpointinfo` (
   `userId` varchar(10) NOT NULL,
   `examname` varchar(255) NOT NULL,
   `riskcontrolgoal` int(3) DEFAULT NULL,
   `satisfact1` int(3) DEFAULT NULL,
   `satisfact2` int(3) DEFAULT NULL,
   `workdiscip` int(3) DEFAULT NULL,
   `deductpointdate` date NOT NULL,
   `state` int(1) NOT NULL,
   PRIMARY KEY (`userId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
